...
def rpsblast(directory, profile_db, output_name, genus):
    ...
    SearchIO.write(qresults, "rpsblast_DUF1795_Rhizobium.xml", "blast-xml")
    return None
...
if __name__ == "__main__":
    ...
    output_rps = os.path.join(os.getcwd(), "rizobia-blast", "rpsblastResult_DUF1795_Lewis.xml")

    #profile_db(PSSM_file, os.path.join(output_dir_profile, output_name_profile))
    rpsblast(dir_protein, f"{os.getcwd()}/rizobia-profiledb/DUF1795_profiledb", output_rps, "Rhizobium")
